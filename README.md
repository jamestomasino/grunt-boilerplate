...
/Users/james.tomasino/Sites/git/work/grunt-boilerplate/hooks/pre-commit:21:	find ${LOCAL_DIR} -type f -exec grep -H -n '(TODO|FIX(ME)?):' {} \; 2> /dev/null > $TODO
/Users/james.tomasino/Sites/git/work/grunt-boilerplate/TODO.md:1:/Users/james.tomasino/Sites/git/work/grunt-boilerplate/hooks/pre-commit:21:	find ${LOCAL_DIR} -type f -exec grep -H -n '(TODO|FIX(ME)?):' {} \; 2> /dev/null > $TODO
## COMMIT LOG ##
